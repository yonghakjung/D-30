...
public class SpringSecurityConfigure  {
   ...
   public BCryptPasswordEncoder passwordEncoder() {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.formLogin(login -> login.loginPage("/login/loginform")
        ...
        http.logout(logout -> logout.permitAll().logoutUrl("/logout").logoutSuccessUrl("/home").invalidateHttpSession(true));
        //http.exceptionHandling(handling -> handling.authenticationEntryPoint(new CustomAuthenticationEntryPoint("/loginForm")));
        http.exceptionHandling(handling -> handling.accessDeniedPage("/accessDeniedView"));   
